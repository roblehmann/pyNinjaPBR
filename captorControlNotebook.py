...
class captorControlNotebook(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.label_1_copy_1_copy = wx.StaticText(self, wx.ID_ANY, _("Upper Threshold (740nm)"))
        self.text_ctrl_turbido_upper_thr = wx.TextCtrl(self, wx.ID_ANY, _("1"), style=wx.TE_PROCESS_ENTER)
        self.label_2_copy_copy = wx.StaticText(self, wx.ID_ANY, _("Lower Threshold (740nm)"))
        self.text_ctrl_turbido_lower_thr = wx.TextCtrl(self, wx.ID_ANY, _("0.8"), style=wx.TE_PROCESS_ENTER)
        self.label_3_copy_copy = wx.StaticText(self, wx.ID_ANY, _("Dilution Step Length (sec)"))
    ...
    def __do_layout(self):
        ...
        sizer_mode_light.Add(self.mode_radio_box, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.SHAPED, 0)
        sizer_light_general.Add(self.label_4_copy_copy, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_light_general.Add(self.text_ctrl_min_led_bght, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_light_general.Add(self.label_5_copy_copy, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_light_general.Add(self.text_ctrl_max_led_bght, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_light_general.Add(self.label_6_copy_copy, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_light_general.Add(self.text_ctrl_sampling_rate, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_light_general.Add(self.button_odPlot, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 10)
        sizer_mode_light.Add(sizer_light_general, 1, wx.EXPAND, 0)
        sizer_main_content.Add(sizer_mode_light, 1, wx.EXPAND, 0)
        sizer_13.Add(self.label_7, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_13.Add(self.mode_schedule_combo_box, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_13.Add(self.label_8, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_13.Add(self.text_ctrl_mode_change_time, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_main_content.Add(sizer_13, 1, wx.EXPAND, 0)
        sizer_14.Add(self.button_turbidostat_mode, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_14.Add(self.label_1_copy_1_copy, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_14.Add(self.text_ctrl_turbido_upper_thr, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_14.Add(self.label_2_copy_copy, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
        sizer_14.Add(self.text_ctrl_turbido_lower_thr, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_14.Add(self.label_3_copy_copy, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 10)
